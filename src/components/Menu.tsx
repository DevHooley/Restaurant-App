...
const Paragraph = "text-center grid grid-cols-2 text-left text-sm ";
const imgFalafel = "h-48 ";
const pasta = "h-48";
    ...
    <div className="mt-5">
      <section className={section}>
        ...
        <p className={Paragraph}>
          <img className={imgFalafel} src={falafel} alt="A plate of falafel" />
          deep-fried balls made from chickpeas & fava beans, plus fresh herbs
          and spices.
        </p>
        <h2 className={H2}>pasta salad</h2>
        <p className={Paragraph}>
          <img src={pastaSalad} className={pasta} alt="" />A mashup between
          Greek and Italian pasta salad, Kalamata olives, green olives,
          mozzarella cheese, three herb italian pasta{" "}
        </p>
      </section>
    </div>
  );
